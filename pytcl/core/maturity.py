...
MODULE_MATURITY: Dict[str, MaturityLevel] = {
    ...
    "navigation.ins": MaturityLevel.EXPERIMENTAL,  # demoted v2.11.1: ins_error_state_matrix's oracle (tests/validation/test_ins_error_matrix.py) found 17 of 30 non-zero 9x9 navigation-block entries disagreeing with mechanize_ins_ned's own Jacobian -- 11 of 12 in the attitude rows, whose -[omega_in^n x] phi self-coupling submatrix is entirely absent; three vertical-channel entries (sign errors + a missing term) were fixed, the rest is tracked as xfail
    # plotting
