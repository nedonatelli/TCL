...
class TestAltitudeRange:
    ...
    def test_low_altitude(self):
        ...
        output_sea = nrlmsise00(
            ...
            year=2024, day_of_year=1, seconds_in_day=0
        )
        
        # 10 km
        output_10km = nrlmsise00(
            latitude=0, longitude=0, altitude=10_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
    ...
    def test_mesosphere(self):
        ...
        output = nrlmsise00(
            latitude=0, longitude=0, altitude=75_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
    ...
    def test_thermosphere_low(self):
        ...
        output = nrlmsise00(
            latitude=0, longitude=0, altitude=150_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
    ...
    def test_thermosphere_high(self):
        ...
        output = nrlmsise00(
            latitude=0, longitude=0, altitude=500_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
    ...
    def test_exosphere(self):
        ...
        output = nrlmsise00(
            latitude=0, longitude=0, altitude=800_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
...
class TestSolarActivity:
    ...
    def test_quiet_activity(self):
        ...
        output_quiet = nrlmsise00(
            latitude=0, longitude=0, altitude=300_000,
            year=2024, day_of_year=1, seconds_in_day=0,
            f107=70, f107a=70, ap=0
        )
        
        output_avg = nrlmsise00(
            latitude=0, longitude=0, altitude=300_000,
            year=2024, day_of_year=1, seconds_in_day=0,
            f107=150, f107a=150, ap=5
        )
...
class TestMagneticActivity:
    ...
    def test_quiet_geomag(self):
        ...
        output_quiet = nrlmsise00(
            latitude=0, longitude=0, altitude=300_000,
            year=2024, day_of_year=1, seconds_in_day=0,
            f107=150, f107a=150, ap=0
        )
        
        output_active = nrlmsise00(
            latitude=0, longitude=0, altitude=300_000,
            year=2024, day_of_year=1, seconds_in_day=0,
            f107=150, f107a=150, ap=100
        )
...
class TestLatitudeVariation:
    ...
    def test_equator_vs_pole(self):
        ...
        output_pole = nrlmsise00(
            latitude=np.pi/2, longitude=0, altitude=300_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
...
class TestTemperatureProfile:
    ...
    def test_troposphere_lapse_rate(self):
        ...
        output_5km = nrlmsise00(
            latitude=0, longitude=0, altitude=5_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
    ...
    def test_stratosphere_warming(self):
        ...
        output_11km = nrlmsise00(
            latitude=0, longitude=0, altitude=11_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
        
        output_20km = nrlmsise00(
            latitude=0, longitude=0, altitude=20_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
...
class TestCompositionMixes:
    ...
    def test_total_density_from_species(self):
        ...
        na = 6.02214076e23
        mw = {
            'N2': 28.014, 'O2': 31.999, 'O': 15.999,
            'He': 4.003, 'H': 1.008, 'Ar': 39.948, 'N': 14.007
        }
    ...
    def test_atomic_oxygen_high_alt(self):
        ...
        output = nrlmsise00(
            latitude=0, longitude=0, altitude=200_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
    ...
    def test_helium_exosphere(self):
        ...
        output = nrlmsise00(
            latitude=0, longitude=0, altitude=400_000,
            year=2024, day_of_year=1, seconds_in_day=0
        )
...
class TestNumericalProperties:
    ...
    def test_positive_densities(self):
        ...
        output = nrlmsise00(
            latitude=np.radians(45), longitude=np.radians(-75),
            altitude=300_000,
            year=2024, day_of_year=100, seconds_in_day=43200
        )
    ...
    def test_temperature_positive(self):
        ...
        output = nrlmsise00(
            latitude=np.zeros_like(alts), longitude=np.zeros_like(alts),
            altitude=alts,
            year=2024, day_of_year=1, seconds_in_day=0
        )
    ...
    def test_consistency_scalar_vs_array(self):
        ...
        output_scalar = nrlmsise00(
            latitude=0.5, longitude=1.0, altitude=200_000,
            year=2024, day_of_year=50, seconds_in_day=20000,
            f107=150, f107a=150, ap=10
        )
        
        # Array with single element
        output_array = nrlmsise00(
            latitude=np.array([0.5]), longitude=np.array([1.0]),
