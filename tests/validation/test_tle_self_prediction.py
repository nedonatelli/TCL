...
# Calibration probe (2026-08-08, see tests/fixtures/tle/SOURCES.md for the
# verbatim run): measured (median km/day, p95 km) per regime, this fixture --
#   25544 leo-high-drag        pairs 78  med 0.444  p95 0.501
#   45098 leo                  pairs 53  med 2.05   p95 6.23
#   28474 meo-deep-space       pairs 33  med 0.256  p95 0.558
#   41866 geo-deep-space       pairs 89  med 0.59   p95 0.541
#   25485 heo-high-eccentricity pairs 12 med 0.362  p95 2.798
#   69702 decaying              pairs 64 med 21.779 p95 36.0
...
class TestSelfPrediction:
    ...
    def test_velocity_within_envelope(self, history):
        ...
        # Measured worst p95 (69702, decaying): 0.04106 km/s -> x1.5 -> 0.07.
        worst = 0.0
