...
|version_badge| — |n_functions| functions | |n_modules| modules | |n_tests| test functions | ty type-checked | 90% coverage | 9 interactive notebooks | GPU acceleration (CuPy + MLX)
